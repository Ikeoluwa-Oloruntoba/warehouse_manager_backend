...
class ProductMovementSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'product_id', 'from_location',
                  'to_location', 'status', 'created_at', 'updated_at', 'qty_to_be_moved']
...
class ProductSerializer(WritableNestedModelSerializer, serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['Product_id', 'product_name', 'product_image', 'qty_in_stock',
                  'added_by', 'created_at', 'updated_at', 'location', 'movelocation']
