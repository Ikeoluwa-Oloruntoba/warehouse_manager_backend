...
class Location(models.Model):
    ...
    product_id =  models.ForeignKey(Product, on_delete=models.CASCADE ,related_name='location', null=True, blank=True)
...
class ProductMovements(models.Model):
    ...
    id =  models.AutoField(primary_key=True)
    product_id =  models.ForeignKey(Product, on_delete=models.CASCADE, related_name='movelocation', null=True, blank=True)
